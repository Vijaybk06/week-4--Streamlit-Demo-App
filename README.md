[README.md.txt](https://github.com/user-attachments/files/30462090/README.md.txt)
# week-4--Streamlit-Demo-App
What to do:  • Wrap your best model in a Streamlit app that runs locally. • The user enters feature values and the app returns a prediction.
